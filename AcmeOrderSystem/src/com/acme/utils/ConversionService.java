...
public class ConversionService {
	 ...
	 */
	// conversion rate for 1 kilograms to pounds
	public static double kilogramToPounds = 2.2046;
	// conversion rate for 1 kilograms to grams
	public static int kilogramToGrams = 1000;
	// conversion rate for 1 kilograms to weight ounces
	...
	public static double[][] allKgToPounds(double... kilogramValues) {
		double [][] result = new double[kilogramValues.length][2];
		for (int i =0; i < kilogramValues.length; i++) {
			result[i][0] = kilogramValues[i];
			result[i][1] = pounds(kilogramValues[i]);
		}
		return result;
	}
